...
| [004](ADR-004-plugin-repo-structure.md) | Plugin Repo Structure — Separate Repos, Not a Monorepo | Accepted | Plugins are independent repos; JSON-RPC over stdio is the only contract. *(Amended June–July 2026: repos renamed; install resolution hardened; optional plugin-owned text renderers added.)* |
